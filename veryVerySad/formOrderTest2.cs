...
{
    public partial class formOrderTest2 : Form
    {
        ...
        public formOrderTest2()
        {
            InitializeComponent();
        }

        private void formOrderTest2_Load(object sender, EventArgs e)
        {
            try
            {
                cafeConnection = new SqlConnection("Data Source = NUTTY;" + "Initial Catalog = soSadCafeDB;" +
